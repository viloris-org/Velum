...
the generated certificate and key, atomically replaces the PEM paths from the
Velum configuration, and requests a local socket reload. The ACME account and
